...
const FormAdd = ({ formData, setFormData }) => {
    ...
    const [valueCertificates, setValueCertificates] = useState();
    ...
    useEffect(() => {
        setFormData({ ...formData, description: value, certification: valueCertificates })
    ...
    return (
        <form className="container rounded bg-white" style={{ width: "900px" }}>
            <div className="row">
                ...
                <div className="col-md-9 border-right">
                    <div className="p-1 py-2">
                        ...
                        <div className="row mt-3">
                            ...
                            <div className="col-md-12">
                                <label className="labels">video Link</label>
                                <input onChange={handleChange} type="text" className="form-control" name="videolink" placeholder="Certification" />
                            </div>
                ...
                <div className="col-md-12">
                    ...
                    <CertificationEditor setValueCertificates={setValueCertificates} />
                    <br />
