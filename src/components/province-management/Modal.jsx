...
import * as Provinces from '../../actions/province-manager/provinceAction'
...
const RModal = ({ show, onHide, data, type = 'add' }) => {
    ...
    function onSubmit() {
        type === 'add'
            ? dispatch(Provinces.fnCreateProvince(formData))
            : dispatch(Provinces.fnUpdateProvince(formData))
    }
