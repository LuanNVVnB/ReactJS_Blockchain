...
import CandidateVoteMultipleModal from './CandidateVoteMultipleModal';
import { GetAccountMetaMask } from '../../utils/checkConnectMM';

function BlogMutiple(candidate) {
												...
												</li>
												{
													voted.length > 0 && voted?.find(item => item === ballot.id) ?
														<li className="tag__item play blue" onClick={() => {
															...
															<i class="fa fa-check-circle" aria-hidden="true"></i>Voted
														</li>
														:
														<li className="tag__item play blue" onClick={() => { hanldeOpenVote(ballot) }} >
															<i class="fa fa-hand-o-right" aria-hidden="true"></i>Vote
														</li>
												}
